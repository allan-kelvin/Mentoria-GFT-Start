...
public abstract class FuncionarioPJ {
    ...
    public String toString() {
        return "FuncionarioPJ{" + "nome=" + nome + ", documento=" + documento + ", endereco=" + endereco + ", horasTrabalhadas=" + horasTrabalhadas + ", valorHora=" + valorHora + ", valorRemuneracao=" + valorRemuneracao + '}';
    }
